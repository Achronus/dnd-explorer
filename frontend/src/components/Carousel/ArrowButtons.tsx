  ...
  return (
    <button
      className={cn(
        ...
        `${styles.embla__button}--${btnType}`,
        "btn btn-outline bg-black w-12 h-12 mb-4"
      )}
      type="button"
      {...restProps}
    >
...
const PrevButton = ({
  ...
  return (
    <EmblaButton btnType="prev" {...restProps}>
      {children}
    </EmblaButton>
  );
};
...
const NextButton = ({
  ...
  return (
    <EmblaButton btnType="next" {...restProps}>
      {children}
    </EmblaButton>
  );
};

export { NextButton, usePrevNextButtons, PrevButton };
